...
const Profile = () => {
    ...
    const profileContent = [
        ...
        { title: "Interdisciplinary", content: 'History, politics, philosophy, space, technology, biology, physics, arts, engineering, and so on. I need to learn and explore new disciplines to excel in solving crossword puzzles.' },
